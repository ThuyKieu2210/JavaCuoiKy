...
//	private JPanel panel;
    ...
    public TrangChuView() {
		...
		btnQlKho.setBounds(20, 256, 203, 42);
		...
		btnThngK.setBounds(20, 375, 203, 42);
				...
				new Thread(new Runnable() {
					...
					public void run() {
						SwingUtilities.invokeLater(new Runnable() {
							@Override
							public void run() {
								switchPanel(new ThongKePanel().getPanel());
							}
						});
					}
				}).start();
